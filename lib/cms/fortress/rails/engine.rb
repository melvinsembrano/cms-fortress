  ...
  module Fortress
    class Engine < ::Rails::Engine
      ...
      initializer :assets do |config|
        Rails.application.config.assets.precompile += %w( cms/fortress/bootstrap.js cms/fortress/admin_overrides.css cms/fortress/session.css cms/fortress/themes/wide.css cms/fortress/themes/wide.js cms/fortress/media.js)
      end
    end
  end
end
